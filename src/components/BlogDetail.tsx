    ...
    <div className="detail">
      <div>
        ...
        <p className="content">
          ...
          increased performance/output. However, there are a surprising number
          of hidden costs and benefits that can significantly impact the
          decision. When considering new Automation it is common to go through a
          Return on Investment ROI calculation to decide if the Automation cost
          is worth it. This generally involves basic items such as labour
          savings, increased performance/output. However, there are a surprising
          number of hidden costs and benefits that can significantly impact the
          decision. When considering new Automation it is common to go through a
          Return on Investment ROI calculation to decide if the Automation cost
          is worth it. This generally involves basic items such as labour
          savings, increased performance/output. However, there are a surprising
